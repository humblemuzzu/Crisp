...
# code_only(): blanks Swift comments while preserving line numbers and string
# contents. Shared with scripts/check-accessibility.sh, which needs the same
# "prose is not code" rule for the same reason.
